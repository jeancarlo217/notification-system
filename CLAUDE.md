...
interface). B12, B13 and B14 are done: the catalogue and the submitter with their eleven migrations
...
system with the two combobox widgets the two fields use. B15 is open.
