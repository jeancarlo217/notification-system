...
## [2026-08-28] decision | Owner: Django's administration site stays, with the framework's standard authentication, mounted inside the secret path segment (B5 moves it there); the employee-facing form, list and lifecycle actions stay without any login. Foundation sections 6, 10 and 13, CLAUDE.md and backlog B5 updated in the same pass.
