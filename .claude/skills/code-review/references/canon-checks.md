...
| **I4** business values are data | a threshold (30, 7, 0), the destination number, the message template or the secret path segment as a literal in a function or a migration; a config value read somewhere other than the settings boundary |
